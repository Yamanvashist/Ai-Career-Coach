    ...
    <div className="min-h-screen bg-slate-50 p-4 md:p-8 space-y-8 font-sans text-slate-900">
      <div className="space-y-1">
        ...
        <p className="text-slate-500">
          Welcome back, <span className="font-semibold text-indigo-600">{user?.name ?? "John Doe"}</span>
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 items-start">
        ...
        >
          <div className="space-y-1">
            <h2 className="text-xl font-bold tracking-tight">Career Readiness Index</h2>
            <p className="text-sm text-slate-500">Your overall readiness score</p>
          </div>
          ...
          <div className="mt-8 flex flex-col md:flex-row gap-8 lg:gap-12 items-center">
            <div className="w-48 h-48 sm:w-52 sm:h-52 shrink-0 bg-white rounded-full shadow-inner p-4 border border-slate-50">
              <div className="relative w-full h-full">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-4xl font-extrabold tracking-tighter text-slate-900">78%</span>
            ...
            <div className="flex flex-col gap-5 flex-1 w-full">
              <h3 className="text-sm font-bold uppercase tracking-wider text-slate-400">Top Factors</h3>
        ...
        <div className="w-full h-full rounded-2xl bg-white p-6 md:p-8 shadow-sm border border-slate-200">
          ...
          <p className="text-sm text-slate-500 mt-1">Jump into your most important tasks</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
            ...
            <div className="group border border-slate-200 hover:border-blue-300 rounded-xl p-5 flex flex-col justify-between bg-slate-50/50 hover:bg-blue-50/30 hover:shadow-md transition-all duration-200 min-h-55">
              <div>
                ...
                <h3 className="font-bold text-slate-900 mt-4 text-sm">Resume</h3>
                <p className="text-xs text-slate-500 mt-1">Upload updated CV</p>
                <ul className="mt-4 space-y-2 text-xs text-slate-600">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-blue-500" /> Get AI feedback
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-blue-500" /> Improve score
                  </li>
                </ul>
              </div>
            ...
            <div className="group border border-slate-200 hover:border-emerald-300 rounded-xl p-5 flex flex-col justify-between bg-slate-50/50 hover:bg-emerald-50/30 hover:shadow-md transition-all duration-200 min-h-55">
              <div>
                ...
                <h3 className="font-bold text-slate-900 mt-4 text-sm">Code Critic</h3>
                <p className="text-xs text-slate-500 mt-1">Paste a new function</p>
                <ul className="mt-4 space-y-2 text-xs text-slate-600">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500" /> Instant review
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500" /> Identify issues
                  </li>
                </ul>
              </div>
            ...
            <div className="group border border-slate-200 hover:border-indigo-300 rounded-xl p-5 flex flex-col justify-between bg-slate-50/50 hover:bg-indigo-50/30 hover:shadow-md transition-all duration-200 min-h-55">
              <div>
                ...
                <h3 className="font-bold text-slate-900 mt-4 text-sm">Interview</h3>
                <p className="text-xs text-slate-500 mt-1">Launch 5-min drill</p>
                <ul className="mt-4 space-y-2 text-xs text-slate-600">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-indigo-500" /> Practice with AI
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-indigo-500" /> Boost confidence
                  </li>
                </ul>
              </div>
      ...
      <div className="w-full rounded-2xl bg-white p-6 md:p-8 shadow-sm border border-slate-200 mt-8">
        ...
        <div className="divide-y divide-slate-100">
          {[
            ...
            <div key={i} className="py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-slate-50 transition-colors -mx-4 px-4 rounded-lg">
