...
const resources = [
  {
    ...
    description:
      "Build crisp, ATS-friendly resumes that spotlight your strongest achievements.",
    label: "Free",
  },
  {
    title: "Interview Question Packs",
    description:
      "Practice role-specific interview questions that match the hiring market.",
    label: "Popular",
  },
  {
    title: "Career Growth Guides",
    description:
      "Follow clear steps to close skill gaps and get on a faster career track.",
    label: "Recommended",
  },
];
...
const articles = [
  {
    ...
    summary:
      "Learn the quick fixes recruiters expect and how to improve every application.",
  },
  {
    title: "How to Answer Behavioral Questions",
    summary:
      "Structure your stories with the right mix of context, action, and outcome.",
  },
  {
    title: "Roadmap to Senior Roles",
    summary:
      "See the skills, milestones, and preparation needed to move up faster.",
  },
];
    ...
    <main className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-200">
      <section className="border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 py-24 transition-colors">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
            Explore guides, templates, and interview resources built for job
            seekers who want a simple path to better outcomes.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid gap-10 lg:grid-cols-3">
            {articles.map((article) => (
              <article
                key={article.title}
                className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 p-8 shadow-sm dark:shadow-[0_25px_60px_-40px_rgba(15,23,42,0.75)] transition-all hover:-translate-y-1"
              >
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-950 transition-colors">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
            Our resource library is built to help you improve resumes, prepare
            for interviews, and reach the next level of your career.
          </p>
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              href="/sign-up"
