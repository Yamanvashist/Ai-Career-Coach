...
const resourceCards = [
  {
    ...
    description: "Modern formats built for ATS, optimized for clarity and impact.",
  },
  {
    title: "Interview Guides",
    description: "Role-specific prep that helps you answer with structure and confidence.",
  },
  {
    title: "Career Toolkit",
    description: "Skill gap reports, roadmaps, and learning plans for fast improvement.",
  },
];
...
const featuredPlans = [
  {
    name: "Starter",
    price: "₹0/month",
    details: ["30 credits per month", "Essential resume suggestions", "Career progress summary"],
  },
  {
    name: "Pro",
    price: "₹299/month",
    details: ["300 credits per month", "Priority AI review", "Interview prep boost"],
    highlight: true,
  },
  {
    name: "Ultimate",
    price: "₹699/month",
    details: ["1000 credits per month", "Unlimited resume checks", "Full mock interview suite"],
  },
];
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            {highlights.map((item) => (
              ...
              >
                ...
                <p className="mt-4 text-slate-600 dark:text-slate-300 leading-relaxed">{item.description}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-6 text-lg text-slate-600 dark:text-slate-300 max-w-xl leading-relaxed">
                Build a stronger resume, uncover missing skills, and get interview-ready with tools that keep every step aligned to your goals.
              </p>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              {resourceCards.map((resource) => (
                ...
                >
                  ...
                  <p className="mt-4 text-slate-600 dark:text-slate-300 leading-relaxed">{resource.description}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-12 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-6 text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
                Choose the right level of support for your next job search—whether you are starting with a basic review or aiming for an interview-ready transformation.
              </p>
            </div>
