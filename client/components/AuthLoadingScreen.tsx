const AuthLoadingScreen = () => {
  return (
    <div 
      className="relative flex h-screen w-full flex-col items-center justify-center overflow-hidden bg-slate-50 transition-colors dark:bg-slate-950"
      role="status"
      aria-live="polite"
      aria-label="Authenticating"
    >
      <div className="absolute left-1/2 top-1/2 h-96 w-96 -translate-x-1/2 -translate-y-1/2 animate-pulse rounded-full bg-indigo-500/20 blur-[30px]" />
      ...
      <div className="relative flex items-center justify-center">
        ...
        <div className="relative z-10 flex h-16 w-16 animate-pulse items-center justify-center rounded-full border border-white/20 bg-white/50 backdrop-blur-md dark:border-white/10 dark:bg-slate-900/80">
          <svg className="h-8 w-8 text-indigo-600 drop-shadow-[0_0_8px_rgba(79,70,229,0.8)] dark:text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
